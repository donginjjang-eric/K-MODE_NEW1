...
import { getCreatorManagementGroup, listCreatorManagementGroups, listManagedCreators } from "@/lib/creator-management";
...
export default async function AdminCreatorGroupDetailPage({ params }: { params: Promise<{ groupId: string }> }) {
  ...
  if (!group) notFound();
  return <AdminCreatorGroupManager group={group} creators={creators} groups={groups} />;
}
